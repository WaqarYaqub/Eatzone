...
const Header = () => {
  ...
  return (
    <header style={{background: 'linear-gradient(90deg, rgba(131,58,180,1) 0%, rgba(253,29,29,0.5536808473389356) 50%, rgba(252,176,69,1) 100%)'}} className="w-screen fixed z-50 bg-cardOverlay backdrop-blur-md md:p-3 md:px-4 lg:p-6 lg:px-16">
      {/* Tablet and Desktop */}
