...
const Footer = () => {
  return (
    <footer  style={{background: 'linear-gradient(90deg, rgba(131,58,180,1) 0%, rgba(253,29,29,0.5536808473389356) 50%, rgba(252,176,69,1) 100%)'}} className="p-4 bg-primary sm:p-6 w-full">
      ...
      <div className="flex flex-col items-center justify-center md:flex-row md:justify-between">
        <span className="text-sm text-gray-500 text-center dark:text-gray-400">
          © 2023 Eatzone. All Rights Reserved.
        </span>
